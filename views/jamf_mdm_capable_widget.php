...
$(document).on('appUpdate', function(e, lang) {
	...
	$.getJSON( appUrl + '/module/jamf/get_mdm_capable', function( data ) {
		...
		var card = $('#mdm-capable-widget div.card-body'),
			baseUrl = appUrl + '/show/listing/jamf/jamf#';
		card.empty();

		// Set statuses
		card.append(' <a href="'+baseUrl+'mdm_capable = 1" class="btn btn-success"><span class="bigger-150">'+data.Yes+'</span><br>&nbsp;&nbsp;'+i18n.t('yes')+'&nbsp;&nbsp;</a>');
		card.append(' <a href="'+baseUrl+'mdm_capable = 0" class="btn btn-danger"><span class="bigger-150">'+data.No+'</span><br>&nbsp;&nbsp;&nbsp;'+i18n.t('no')+'&nbsp;&nbsp;&nbsp;</a>');
	});
});
